...
const SelectedTechs = ({ selectedTechs, setSelectedTechs }: selectedProps) => {
    ...
    return (
        ...
        selectedTechs.length===0
           ?"":<div>
                    <button className="font-semibold text-[14px] text-[#D82C20] text-center border-2 border-[#ED8C85] rounded-[8px] px-20 py-2 mt-8 hover:text-white hover:bg-[#D82C20]">Remove All</button>
                </div>
                }
            </div>
        </>
